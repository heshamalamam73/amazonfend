    ...
    <Layout>
      <div className={styles.container}>
        ...
        <div className={styles.filter}>
          <div className={styles.filter_item}>3 ordinin effettuati </div>
            ...
            <div className={styles.order_item}>
              <div className={styles.order_item_head}>
                <div className={styles.grid_item}>
                  ...
                  <span className={styles.blu}>3 gennaio 2021</span>
                </div>
                <div className={styles.grid_item}>
                  TOTALE
                ...
                <div className={styles.grid_item}>
                  INVIA A
                  <span className={styles.blu}>
                    {" "}
                    mahmoud hassan hamed okily
                  </span>
                </div>
                <div className={styles.grid_item}>
                  ORDINE #{" "}
                  <span className={styles.blu}> 402-1436974-5860323</span>
                </div>
              </div>
              <div className={styles.order_item_body}>
                <div className={styles.grid_2_body}>
                  <div className={styles.order_details}>
                    <div className={styles.ship_date}>
                      Consegnato: <span className={styles.blu}>ieri</span>
                    </div>
                    <div className={styles.ship_status}>
                      Il pacco è stato consegnato presso il domicilio
                      selezionato
                    </div>
                    <div className={styles.product}>
                      <div>
                        <img
                          src="https://images-eu.ssl-images-amazon.com/images/I/41-fcQL%2B7NL._SY90_.jpg"
                          alt=""
                        />
                      </div>
                      <div>
                        <div className={styles.product_title}>
                          ...
                          Culla Regolabile per Cruscotto e Parabrezza, Porta
                          Cellulare per Molti Smartphone e Dispo
                        </div>
                        <div>
                          Venduto da:{" "}
                          <span className={styles.blu}>SJH EU LTD</span>
                        </div>
                        <div>Idoneo al reso fino al 04 feb 2021</div>
                        <div className={styles.product_price}>EUR 12,99</div>
                        <div>
                  ...
                  <div className={styles.order_action}>
                    <div>
                      <button>Traccia il mio pacco</button>
                    </div>
                    <div>
                      <button>Traccia il mio pacco</button>
                    </div>
              ...
              <div className={styles.order_footer}>Archivia ordine</div>
            </div>
          </div>
          <div>
